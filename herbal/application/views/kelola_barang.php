...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="col-lg-12">
				...
				<div class="breadcrumbs">
                    <div class="page-title">
                        <a href="<?php echo base_url('index.php/barang/inputbarang'); ?>" title="Input Barang" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
              </div>
              <h3></h3>
			</div>
		...
		$form->setView('index.php/barang/kelolabarang');
		$form->addInput('id','link');
		$form->setLink('id',base_url('index.php/barang/inputbarang'), 'id');
		...
		$form->setEditLink(base_url('index.php/barang/inputbarang?id='));
		$form->setEdit(TRUE);
		$form->setDelete(TRUE);
		$form->form();
		 ?>
