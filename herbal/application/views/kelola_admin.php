...
<head>
	...
	<title>Herbal's Store - Kelola Admin</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="col-lg-12">
				...
				<div class="breadcrumbs">
                    <div class="page-title">
                        <a href="<?php echo base_url('index.php/admin/inputadmin'); ?>" title="Tambah Admin" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
              </div>
              <h3></h3>
			</div>
		...
		$form->setView('index.php/admin/kelolaadmin');
		$form->addInput('id','link');
		$form->setLink('id',base_url('index.php/admin/inputadmin'), 'id');
		$form->addInput('nama','plaintext');
		$form->addInput('email','plaintext');
		$form->addInput('password','plaintext');
		$form->setEditLink(base_url('index.php/admin/inputadmin?id='));
		$form->setEdit(TRUE);
		$form->setDelete(TRUE);
		$form->form();
		 ?>
