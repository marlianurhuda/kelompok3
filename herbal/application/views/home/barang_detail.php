		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="<?php echo base_url('assets/tampilan/images/icons/icon-close2.png'); ?>" alt="CLOSE">
				</button>
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="wrap-slick3-arrows flex-sb-m flex-w"></div>							
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo base_url('images/modules/barang/'.$a['id'].'/'.$a['image']) ?>" style="height: 70%;" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo base_url('images/modules/barang/'.$a['id'].'/'.$a['image']) ?>">
