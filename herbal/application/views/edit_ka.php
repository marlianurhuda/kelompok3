...
<head>
	...
	<title>Herbal's Store - Edit Kategori Artikel</title>
			...
			<div class="col-lg-12">
				...
				<div class="breadcrumbs">
                    <div class="page-title">
                        <a href="<?php echo base_url('index.php/kategori_artikel/kelolaka'); ?>" title="Kelola Kategori Artikel" class="btn btn-warning"><i class="fa fa-archive"></i> Kelola</a>
                    </div>
              </div>
              <h3></h3>
			</div>
			...
			<div class="col-md-12 col-sm-6 col-xs-12">
                <div class="panel panel-info">
                	...
                	<div class="panel-body">
                		<form role="form" action="<?php echo base_url('index.php/kategori_artikel/updateka'); ?>" method="POST">
                			<?php foreach ($query->result() as $baris) { ?>
                			<input type="hidden" name="id_kategori_artikel" value="<?php echo $baris->id_kategori_artikel; ?>">
                			<div class="form-group">
                				<label>Nama Kategori Artikel</label>
                				<input class="form-control" type="text" name="nama_kategori_artikel" required="" value="<?php echo $baris->nama_kategori_artikel; ?>" />
                			</div>
