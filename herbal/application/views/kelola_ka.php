		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1" class="active">
				...
				<ul class="children collapse" id="sub-item-1">
					<li><a class="active" href="<?php echo base_url('index.php/kategori_artikel/kelolaka'); ?>">
			...
			<li><a href="<?php echo base_url('index.php/Login/logout') ?>S"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
		</ul>
	</div><!--/.sidebar-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Kelola Kategori Artikel</li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				...
				<div class="breadcrumbs">
                    <div class="page-title">
                        <a href="<?php echo base_url('index.php/kategori_artikel/inputka'); ?>" title="Tambah Kategori Artikel" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
              </div>
              <h3></h3>
			</div>
		...
		<div class="row">
			...
			foreach ($query->result() as $baris) {
				echo "<tr>";
				echo "<td>".$no."</td>";
				echo "<td>".$baris->nama_kategori_artikel."</td>";
				echo "<td><a href=".base_url('index.php/kategori_artikel/editka/').$baris->id_kategori_artikel.">Edit</a></td>";
				echo "<td><a href=".base_url('index.php/kategori_artikel/hapus/').$baris->id_kategori_artikel.">Hapus</a></td>";
				echo "</tr>";
			$no++; } 
