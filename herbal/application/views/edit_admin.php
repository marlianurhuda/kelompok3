...
<head>
	...
	<title>Herbal's Store - Edit Admin</title>
			...
			<div class="col-md-12 col-sm-6 col-xs-12">
                <div class="panel panel-info">
                	...
                	<div class="panel-body">
                		<form role="form" action="<?php echo base_url('index.php/admin/updateadmin'); ?>" method="POST">
                			<?php foreach ($query->result() as $baris) { ?>
                			<input type="hidden" name="id" value="<?php echo $baris->id; ?>">
                			<div class="form-group">
                				<label>Nama</label>
                				<input class="form-control" type="text" name="nama" required="" value="<?php echo $baris->nama; ?>" />
                			</div>
                			<div class="form-group">
                				<label>Username</label>
                				<input class="form-control" type="text" name="username" required="" value="<?php echo $baris->username; ?>" />
                			</div>
                			<div class="form-group">
                				<label>Password</label>
                				<input class="form-control" type="text" name="password" required="" value="<?php echo $baris->password; ?>" />
                			</div>
