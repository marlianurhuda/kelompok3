...
<body>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
					...
					<span class="icon-bar"></span>
					<s></s>pan class="icon-bar"></span></button>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url('index.php/artikel/inputartikel'); ?>"><em class="fa fa-newspaper-o">&nbsp;</em> Artikel</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="col-lg-12">
				...
				<div class="breadcrumbs">
                    <div class="page-title">
                        <a href="<?php echo base_url('index.php/artikel/inputartikel'); ?>" title="Input Artikel" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
              </div>
              <h3></h3>
			</div>
		...
		$form->setView('index.php/artikel/kelolaartikel');
		$form->addInput('id','link');
		$form->setLink('id',base_url('index.php/artikel/inputartikel'), 'id');
		...
		$form->tableOptions('id_kategori', 'kategori_artikel','id_kategori_artikel','nama_kategori_artikel');
		$form->addInput('image','thumbnail');
		$form->setImage('image','artikel');
		$form->setEditLink(base_url('index.php/artikel/inputartikel?id='));
		$form->setEdit(TRUE);
		$form->setDelete(TRUE);
		$form->form();
		 ?>
