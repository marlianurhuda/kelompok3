	...
	<div class="limiter">
		<div class="container-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?php echo base_url('assets2/images/img-01.png'); ?>" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="<?php echo site_url('index.php/Login/cek_login'); ?>" method="post">
...
<!--===============================================================================================-->
	<script src="<?php echo base_url('assets2/vendor/tilt/tilt.jquery.min.js'); ?>"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
