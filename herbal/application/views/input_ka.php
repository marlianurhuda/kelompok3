...
<head>
	...
	<title>Herbal's Store - Input Kategori Artikel</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Input Kategori Artikel</li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-md-12 col-sm-6 col-xs-12">
                <div class="panel panel-info">
                	...
                	<div class="panel-body">
                		...
                		<form role="form" action="<?php echo base_url('index.php/kategori_artikel/simpan'); ?>" method="POST">
                			<div class="form-group">
                				<label>Nama Kategori Artikel</label>
                				<input class="form-control" type="text" name="nama_kategori_artikel" required="" />
                			</div>
