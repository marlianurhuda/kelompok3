...
<head>
	...
	<title>Herbal's Store - Input Kategori Barang</title>
			...
			<div class="col-md-12 col-sm-6 col-xs-12">
                <div class="panel panel-info">
                	...
                	<div class="panel-body">
                		<form role="form" action="<?php echo base_url('index.php/kategori_barang/simpan'); ?>" method="POST">
                			<div class="form-group">
                				<label>Nama Kategori Barang</label>
                				<input class="form-control" type="text" name="nama_kategori_barang" required=""/>
                			</div>
